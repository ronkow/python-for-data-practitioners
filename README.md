...
When you develop a new package, there may be functionalities in your package that you do not need to implement yourself if there are publicly available packages for these functionalities. You can import these packages into your code. These packages that you import become your package's dependencies. The packages you import may also depend on other packages.
